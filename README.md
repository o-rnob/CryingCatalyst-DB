![CryingCatalyst logo — night-moon owl artwork](https://github.com/o-rnob/CryingCatalyst/raw/main/logo.png)
...
```bash
git clone https://github.com/o-rnob/CryingCatalyst.git
cd CryingCatalyst
```
...
https://github.com/o-rnob/CryingCatalyst
```
